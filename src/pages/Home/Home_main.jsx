...
import Bgweb from '../../static/revopc.gif'
import Bgwebmob from "../../static/revomob.gif"
import Nav from "../../components/Nav/Nav";
import useIsMobile from "../../components/useIsMobile";

const Home_main = () => {
  const countDownDate = new Date("03 April , 2025").getTime() + (3600 * 1000 * 10);
    ...
    <Nav/>
      ...
      >
        ...
        >
          ...
          >
            {dev ? <h6>Department of Information Technology <br/> Proudly Presents</h6> : <h6>Department of  Information Technology <br/> Proudly Presents</h6>}
          ...
          >
            ...
            <strong className="boxStyle">03-04-2025</strong>
            </div> 
            </div> 
            </div>
