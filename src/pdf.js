    ...
    return (
        ...
        <div>
            ...
            <div className="table_container">
                ...
                We have buses operating from Sholinganallur.<br></br><br></br>Participants can use these buses to reach our college. The timings will be updated shortly.
                </p></></table>
            </div>
        </div>
        <div>
            ...
            <div className="table_container">
                ...
                2. Buses will only operate from Sholinganallur. For more details regarding the bus facilities, contact the coordinators.<br></br><br></br>
                3. All students must come in formal attire.<br></br><br></br>
                4. Technical event Participants must bring your own laptop.
                </p></></table>
            </div>
        </div>
        <Footer/>
